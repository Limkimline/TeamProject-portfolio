...
<body>
				...
				<ul class="pagination justify-content-center pagination-sm">
					<c:if test="${PageGroupResult.beforePage}">
						<li class="page-item"><a class="page-link"
							href="lecture_interest_search?reqPage=${PageGroupResult.groupStartNumber-1}&int_no=${int_no}">before</a>
						</li>
					</c:if>
						...
						<c:choose>
							<c:when test="${PageGroupResult.selectPageNumber==index}">
								<li class="page-item active"><a class="page-link "
									href="lecture_interest_search?reqPage=${index}&int_no=${int_no}">
										${index} </a></li>
							</c:when>
					...
					<c:if test="${PageGroupResult.afterPage}">
						<li class="page-item"><a class="page-link"
							href="lecture_interest_search?reqPage=${PageGroupResult.groupEndNumber+1}&int_no=${int_no}">after</a>
						</li>
					</c:if>
				</ul>
			</div>
	...
	<script>
			...
			var element= $('.interestList'); 
			element.children('li:eq(${activaInt_no})').attr('id','aaa');
