...
<body>
	...
	<hr/>
		<form method="post" name="lectureinput" enctype="multipart/form-data" action="lecture_insert">
			<table>
				<tr>
					<td class="td1">개설자</td>
					<td>${user.name}</td>
				...
				<tr>
					<td class="td1">강의명</td>
					<td><input type="text" name="name" placeholder="강의명을 입력하세요"></td>
				</tr>
				<tr>
					<td class="td1">강의설명</td>
					<td colspan="2"><textarea name="content" placeholder="강의설명을 입력하세요" style="width:250px; height:150px;"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3" align=center>
						...
						<input type="button" value="강의개설" id="lectureCreate" class="btn btn-primary">
						<input type="reset" value="개설 취소" class="btn btn-primary">
					</td>
				</tr>
			</table>
